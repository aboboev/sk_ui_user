...
@Component({
    ...
    templateUrl: './usdwallet.page.html',
    styleUrls: ['./usdwallet.page.scss']
})
export class UsdwalletPage implements OnInit {
    profile: any = {};
    iban_code_usd = '';
    ...
    depositUSD() {
        ...
        this.financeApi.financeDeposit('USD', this.deposit).subscribe( (res:any) => {
    ...
    submitWithdraw() {
        ...
        this.settings.loading = true;
        this.financeApi.financeWithdraw('USD', this.withdraw).subscribe( (res:any) => {
            this.settings.loading = false;
            if (res.success) {
